...
class AuthController {
    constructor() {
        ...
        this.router.post('/login', validation_middleware_1.default.validate(login_user_dto_1.default, false), this.isAuthenticated, (0, catch_error_1.default)(this.login)); // if cookie and jwt are not set, handle login request
